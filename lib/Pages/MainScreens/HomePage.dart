            ...
            child: Padding(
              ...
              child: Column(
                ...
                child:Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('Food for you',style: TextStyle(fontFamily: ('font'),fontWeight:FontWeight.bold,fontSize: 20),
                    
                    ),Row(children: [Text('All',style: TextStyle(fontWeight: FontWeight.bold,color:  Color.fromRGBO(248, 198, 33, 1)),),
                    Icon(Icons.arrow_drop_down,size:20,color:  Color.fromRGBO(248, 198, 33, 1),),],)
